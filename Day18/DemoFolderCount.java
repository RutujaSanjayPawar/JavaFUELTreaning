...
public class DemoFolderCount {  // declear class 
...
File f1;
f1 = new File("C:\\JAVA_Programming\\Day18");
...
int fileCount=f1.list().length;  // we count all listed files and folder inside Day14_assignment 
  ...
  int countd = 0;   // count only directory
      ...
      for (File f3 : arr1) {
        ...
        System.out.println("Total Directory count is "+countd); //  Total count of Directory 
